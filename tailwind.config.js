...
module.exports = {
  ...
  variants: {
    ...
    backgroundColor: ['responsive', 'hover', 'focus', 'sibling-checked', 'dark', 'group-hover', 'focus-within'],
    ...
    textColor: ['responsive', 'hover', 'focus', 'sibling-checked','dark', 'group-hover', 'focus-within'],
