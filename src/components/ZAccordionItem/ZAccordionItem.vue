<template>
  <div
    ...
    :class="{
      'border-slate-400 border-t border-b first:border-0 last:border-0 hover:bg-ink-300': this.showBorders,
  ...
  >
    ...
    <div
      ...
      :class="[
        this.open ? (this.spanCustomHeight ? customMaxHeight : 'max-h-52') : 'max-h-0',
