  ...
  template: `<div class="bg-gradient-galaxy">
      ...
      <z-nav class="mb-12">
        ...
        <template slot="mobile-cta">
          <z-button size="none" class="mb-3 h-10 text-base" color="primary">Sign up</z-button>
          <z-button size="none" class="h-10 text-base" color="secondary" type="link" to="https://deepsource.io/">Log in</z-button>
        </template>
      </z-nav>
        ...
        <z-hero>
          ...
          <template slot="cta">
            ...
            <span class="flex flex-wrap items-center justify-center">
              <z-button class="bg-github w-full sm:w-40 mx-3 mb-3 sm:mb-0 h-10 text-base" size="none">
                <span class="flex items-center">
                  <z-icon class="text-normal mr-3 -mt-1" size="medium" icon="github"></z-icon>
                  GitHub
                </span>
              </z-button>
              <z-button class="bg-gitlab w-full sm:w-40 mx-3 mb-3 sm:mb-0 h-10 text-base" size="none">
                <span class="flex items-center">
                  <z-icon class="text-normal mr-3 -mt-1" size="medium" icon="gitlab"></z-icon>
                  GitLab
                </span>
              </z-button>
              <z-button class="bg-bitbucket w-full sm:w-40 mx-3 mb-3 sm:mb-0 h-10 text-base" size="none">
                <span class="flex items-center">
